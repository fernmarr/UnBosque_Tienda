...
public class ProveedorDAO {
	...
	public ArrayList<ProveedorVO> consultarProveedor(String nit_proveedor) {	
		...
		try {
			...
			PreparedStatement consulta = conex.getConnection()
					.prepareStatement("SELECT * FROM tiendagenerica.proveedor where nit_proveedor = ? ");		
	...
	public ArrayList<ProveedorVO> listaDeProveedores() {
		...
		try {
			//prepare la sentencia en la base de datos
			PreparedStatement consulta = conex.getConnection().prepareStatement("SELECT * FROM tiendagenerica.proveedor");
	...
	public void eliminarProveedor(Integer nit_proveedor) {
		...
		try {
			...
			String sentencia = "delete from tiendagenerica.proveedor where nit_proveedor=" + nit_proveedor + ";";
	...
	public void actualizarproveedor(ProveedorVO proveedor) {
		...
		try {
			...
			String sentencia = "UPDATE tiendagenerica.proveedor "
